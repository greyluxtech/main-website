				...
				<div class="owl-carousel dots-inside dots-horizontal-center show-dots-hover nav-inside nav-inside-plus nav-dark nav-md nav-font-size-md show-nav-hover mb-0"
					...
					<div class="position-relative pt-5" style="background-color: #35383d; height: 100vh;">
						<div class="position-absolute top-0 left-0 w-50pct w-lg-auto z-index-2">
							<img src="img/slides/slide-one-page-1-2.jpg" class="w-100 appear-animation"
								data-appear-animation="fadeInRightDownShorter" data-appear-animation-delay="500" alt="">
						</div>
						<div class="position-absolute top-0 right-0 w-50pct w-lg-auto z-index-2">
							<img src="img/slides/slide-one-page-1-3.jpg" class="w-100 appear-animation"
								data-appear-animation="fadeInLeftDownShorter" data-appear-animation-delay="500" alt="">
						</div>
						<div class="position-absolute bottom-0 left-0 w-50pct w-lg-auto z-index-2">
							<img src="img/slides/slide-one-page-1-4.jpg" class="w-100 appear-animation"
								data-appear-animation="fadeInRightUpShorter" data-appear-animation-delay="500" alt="">
						</div>
						<div class="position-absolute bottom-0 right-0 w-50pct w-lg-auto z-index-2">
							<img src="img/slides/slide-one-page-1-5.jpg" class="w-100 appear-animation"
								data-appear-animation="fadeInLeftUpShorter" data-appear-animation-delay="500" alt="">
						</div>
								...
								<div class="col-lg-6">
									<div class="d-flex flex-column align-items-center">
										...
										<a href="#"
											...
											data-appear-animation-delay="1600">GET STARTED NOW!</a>
									</div>
								</div>
							</Div>
						</div>
					...
					<div class="position-relative overlay overlay-show overlay-op-8 pt-5"
						style="background-image: url(img/slides/slide-bg-2.jpg); background-size: cover; background-position: center; height: 100vh;">
						<div class="container position-relative z-index-3 h-100">
							<Div class="row justify-content-center align-items-center h-100">
								<div class="col-lg-6">
									<div class="d-flex flex-column align-items-center">
					...
					<div class="position-relative overlay overlay-show overlay-op-8 pt-5"
						style="background-image: url(img/slides/slide-bg-6.jpg); background-size: cover; background-position: center; height: 100vh;">
						<div class="container position-relative z-index-3 h-100">
							<Div class="row justify-content-center align-items-center h-100">
								<div class="col-lg-6">
									<div class="d-flex flex-column align-items-center">
					...
					<div class="position-relative video overlay overlay-show overlay-op-8 pt-5"
							...
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									...
									<p class="text-color-light opacity-7">Lorem ipsum dolor sit amet, consectetur
										adipiscing <span class="alternative-font text-color-light">metus.</span> elit.
										Quisque rutrum pellentesque imperdiet.</p>
								</div>
							</div>
						</div>
				...
				<div class="row justify-content-center pt-5 mt-5">
					<div class="col-lg-9 text-center">
						...
						<p class="pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
							data-appear-animation-delay="200">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					...
					<div class="row">
						...
						<div class="col-md-6 p-5 my-5">
							<div class="px-4">
								...
								<form class="contact-form form-style-2 pr-xl-5"
									action="https://www.okler.net/previews/porto/8.2.0/php/contact-form.php"
									method="POST">
