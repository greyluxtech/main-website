		...
		<div class="container my-3">
			<div class="row mb-5">
				<div class="col text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
					...
					<p class="text-color-light opacity-7">We offer Variety of Services</p>
				</div>
			</div>
			<div class="row mb-lg-4">
				<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
					<div class="feature-box feature-box-style-2">
						...
						<div class="feature-box-info">
							<h4 class="font-weight-bold text-color-light text-4 mb-2">INVESTMENT</h4>
							<p class="text-color-light opacity-7">Greylux Investments is a subordinate of
								Greylux ltd. We are an investment institution
								which injects funds received from our
								investors into various subordinates of our
								parent company.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
					<div class="feature-box feature-box-style-2">
						...
						<div class="feature-box-info">
							<h4 class="font-weight-bold text-color-light text-4 mb-2">REAL ESTATE</h4>
							<p class="text-color-light opacity-7">Greylux Properties is a subordinate of Greylux ltd a.k.a Greylux Assets ltd. Greylux properties is a
				...
				<div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
					<div class="feature-box feature-box-style-2">
						...
						<div class="feature-box-info">
							<h4 class="font-weight-bold text-color-light text-4 mb-2">IT SOLUTIONS AND CONSULTANCY</h4>
							<p class="text-color-light opacity-7">Greylux Tech is a subordinate of Greylux ltd.
								We are an IT -Information and Technology
								company which focuses on technological
								advancement in all fields of life for easy and
			...
			<div class="row">
				<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
					<div class="feature-box feature-box-style-2">
						...
						<div class="feature-box-info">
							<h4 class="font-weight-bold text-color-light text-4 mb-2">GENERAL MERCHANDISE</h4>
							<p class="text-color-light opacity-7">GreyLux offers different types and kinds of merchandise.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
					<div class="feature-box feature-box-style-2">
						...
						<div class="feature-box-info">
							<h4 class="font-weight-bold text-color-light text-4 mb-2">GENERAL CONTRACTORS</h4>
							<p class="text-color-light opacity-7">GreyLux has variety of contractors for different area of contracts.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					...
					<p class="text-color-light opacity-7">30,000 CUSTOMERS IN 100 COUNTRIES USE PORTO TEMPLATE.
							...
							<div class="testimonial testimonial-style-2 testimonial-light testimonial-with-quotes testimonial-quotes-primary mb-0">
								<blockquote>
									<p class="text-5 line-height-5 mb-0">Lorem ipsum dolor sit amet, consectetur
										adipiscing elit. Sed eget risus porta, tincidunt turpis at, interdum
										tortor. Suspendisse potenti.</p>
								</blockquote>
								<div class="testimonial-author">
									<p><strong class="font-weight-extra-bold text-2">- John Smith.
											Okler</strong></p>
								</div>
							</div>
						</div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8 text-center">
        ...
        <h6 class="subtitle font-weight-normal">Having our customers interets at heart is one of our core values at GreyLux .Find testimonies from satisfied customers below</h6>
      </div>
    </div>
    <!-- Row  -->
			...
			<div class="row">
				...
				<div class="col-md-6 p-5 my-5">
					<div class="px-4">
						...
						<p class="text-3 mb-4">Have any questions? Fill the form below and we'll get back to you</p>
						<form name="contactForm" class="contact-form form-style-2 pr-xl-5" action="" method="POST">
						<div id="alertDiv" style="display:none" class="alert alert-info alert-dismissible">
							...
							<div class="form-row">
								...
								<label for="name"><b>Name</b></label>
									<input type="text" value="" id="name" data-msg-required="Please enter your name." maxlength="100" class="form-control" name="name" placeholder="Name" required>
								</div>
								<div class="form-group col-xl-8">
								<label for="email"><b>Email</b></label>
									<input type="email" value="" id="email"  data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" placeholder="Email" required>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col">
								<label for="subject"><b>Subject</b></label>
									<input type="text" id="subject"  value="" data-msg-required="Please enter the subject." maxlength="100" class="form-control" name="subject" placeholder="Subject" required>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col">
								<label for="message"><b>Message</b></label>
									<textarea maxlength="5000" id="message"  data-msg-required="Please enter your message." rows="4" class="form-control" name="message" placeholder="Message" required></textarea>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col">
									<button type="submit" id="contactUsButton" value="SUBMIT" name="contactUs" class="btn btn-primary" data-loading-text="Loading..."><i id="loaderI" class="fa fa-refresh fa-spin"></i>Submit</button>
								</div>
							</div>
						</form>
					</div>
