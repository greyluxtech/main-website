...
<head>
	...
	<meta name="description" content="GreyLux">
	<meta name="author" content="GreyLux">
...
<body class="one-page loading-overlay-showing" data-target="#header" data-spy="scroll" data-offset="100"
	data-plugin-page-transition data-loading-overlay data-plugin-options="{'hideDelay': 500}">
						...
						<div class="header-column">
							<div class="header-row">
								<div class="header-logo">
									<a href="index.php">
										<img alt="Greylux" width="80" height="80" src="img/logos/logo.png">
									</a>
								</div>
							</div>
						</div>
									...
									<div
										...
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												<li class="nav-item">
													<a data-hash class="nav-link"
														href="index.php">
														Home
													</a>
												</li>
												<li class="dropdown">
													<a class="dropdown-item dropdown-toggle" data-hash data-hash-offset="68"
														href="#services">Services</a>
													<ul class="dropdown-menu">
														<li><a class="dropdown-item" href="#">Investment</a></li>
														<li><a class="dropdown-item" href="#">Real Estate</a></li>
														<li><a class="dropdown-item" href="#">IT Solutions and Consultancy</a></li>
														<li><a class="dropdown-item" href="#">General Merchandise</a></li>
														<li><a class="dropdown-item" href="#">General Contractors</a></li>
													</ul>
												</li>
												<li>
